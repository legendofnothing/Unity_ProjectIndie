        ...
        private void SwitchIndicator(TurnIndicator indicator) {
            ...
            if (_hasDied) {
                s
                    ...
                    .Insert(0, indicatorIcon.DOFade(0, 1.4f).SetUpdate(true))
                    .Append(background.transform.DOLocalMove(originalPos, 0.8f).SetEase(Ease.OutQuint).SetUpdate(true))
                    .Insert(0.6f, backgroundImage.DOColor(currData.backgroundColor, 0.4f).SetUpdate(true));
            }
